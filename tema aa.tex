...
\author{
  \textbf{Drăgușoiu Bogdan Ioan}\\
  \texttt{bogdan.dragusoiu@stud.acs.upb.ro}
  \and
  \textbf{Saveli Victor}\\
  \texttt{victor.saveli@stud.acs.upb.ro}
  \and
  \textbf{Licuriceanu Cristian}\\
  \texttt{clicuriceanu@stud.acs.upb.ro}
  \vspace{1cm}\\
